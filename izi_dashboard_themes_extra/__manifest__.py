...
{
    "name": """Dashboard with AI (Extra Themes)""",
    "summary": """
        Bundling Extra Themes for Analytic Dashboard by IZI.
    """,
    "category": "Reporting",
    "version": "15.0.0.1.12",
    ...
    'assets': {
        ...
        'web.assets_backend': [
            'izi_dashboard_themes_extra/static/src/js/component/chart/amcharts_theme.js',
        ]
    }
}
