...
class ResUsers(models.Model):
    ...
    def _notify_channel(
        ...
        notifications = [(self.env.user.partner_id,record[channel_name_field], bus_message) for record in self]
        # notifications = ([self.env.user.partner_id, 'calendar.alarm', bus_message])
