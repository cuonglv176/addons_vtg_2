                ...
                switch (field.ks_data_comparison) {
                    case "None":
                         if (field.ks_multiplier_active){
                            ...
                            var count = String(self.ksNumFormatter(count_total * field.ks_multiplier, 1));
                            item_info['count'] = String(KsGlobalFunction._onKsGlobalFormatter(count_total * field.ks_multiplier, field.ks_data_format, field.ks_precision_digits));
                         }else{
                            var count_total = count_1 / count_2;
                            ...
                            var count = String(self.ksNumFormatter(count_total, 1));
                            item_info['count'] = String(KsGlobalFunction._onKsGlobalFormatter(count_total, field.ks_data_format, field.ks_precision_digits)) ;
