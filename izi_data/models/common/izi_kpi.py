...
class IZIKPI(models.Model):
    ...
    name_with_sequence = fields.Char('Name', store=True, compute='_compute_name_and_sequence')
    name_with_space = fields.Char('Name', store=True, compute='_compute_name_and_sequence')
    ...
    def create(self, vals):
        rec = super(IZIKPI, self).create(vals)
